        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitsInStock = table.Column<short>(nullable: true, defaultValue: (short)0),
                    UnitsOnOrder = table.Column<short>(nullable: true, defaultValue: (short)0),
                    ReorderLevel = table.Column<short>(nullable: true, defaultValue: (short)0),
